...
const Modal = (props) => {
  ...
  const onDelete = () => {
    API.delete(props.id).catch(function (error) {
      console.log(error);
    });
  };
        ...
        <div className="table_modal">
          ...
          >
            ...
            <InputMask
              ...
              required
            />
            <Button type="addCancel" closeModal={props.closeModal} />
            <Button type="save" />
          </form>
        </div>
      );
      ...
      return (
        <div className="table_modal">
          ...
          >
            ...
            <Button type="deleteCancel" closeModal={props.closeModal} />
            <Button type="confirm" />
          </form>
        </div>
      );
